...
{
    public partial class RegulaTablo : Form
    {
        private SQLiteConnection connection;
        public RegulaTablo()
        {
            InitializeComponent();
            connection = new SQLiteConnection("Data Source=regulaTablo.db;Version=3;");
        }

        private void RegulaTablo_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                SQLiteDataAdapter adapter = new SQLiteDataAdapter("SELECT * FROM regulagecmis", connection);
