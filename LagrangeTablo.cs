...
{
    public partial class LagrangeTablo : Form
    {
        private SQLiteConnection connection;
        public LagrangeTablo()
        {
            InitializeComponent();
            connection = new SQLiteConnection("Data Source=lagrangeTablo.db;Version=3;");
        }

        private void LagrangeTablo_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                SQLiteDataAdapter adapter = new SQLiteDataAdapter("SELECT * FROM lagrangegecmis", connection);
