...
namespace Sayısal_Analiz_Visual_Proje_
{
    public partial class Islemler : Form
    {
        ...
        public Islemler(int sebep, UserSQL userSQL)
        {
            InitializeComponent();
            this.sebep = sebep;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked)
            {
                if (sebep == 0)
                {
                    Taylor taylor = new Taylor(userSQL);
                    taylor.Show();
                }
                if (sebep == 1)
                {
            ...
            if (radioButton5.Checked)
            {
                switch (comboBox1.SelectedIndex)
                {
                    case 0:
                        if (sebep == 0)
                        {
                            Bisection bis = new Bisection(userSQL);
                            bis.Show();
                            break;
                        }
                    ...
                    case 2:
                        if (sebep == 0)
                        {
                            Regula regu = new Regula(userSQL);
                            regu.Show();
                            break;
                        }
            ...
            {if (sebep == 0)
                {
                    NoktaSec lagrange = new NoktaSec(4,userSQL); 
                    lagrange.Show();
                }
            if (sebep == 1) {
            ...
            if (radioButton3.Checked)
            {
                switch (comboBox2.SelectedIndex)
                {
                    case 0:
                        if (sebep == 0)
                        {
                            NoktaSec ileriYon = new NoktaSec(3,userSQL);
                            ileriYon.Show();
                            break;
                        }
                    ...
                    case 1:
                        if (sebep == 0)
                        {
                            NoktaSec geriYon = new NoktaSec(3.1, userSQL);
                            geriYon.Show();
                            break;
                        }
