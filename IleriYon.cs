...
namespace Sayısal_Analiz_Visual_Proje_
{
    public partial class IleriYon : Form
    {
        ...
        UserSQL userSQL;
        public IleriYon(List<double> x, List<double> y, UserSQL userSQL)
        {
            InitializeComponent();
            this.x = x;
            this.y = y;
        ...
        public void createDatabase()
        {
            if (!File.Exists(dbName))
            {
                ...
                command.CommandText = "CREATE TABLE ileriyongecmis(id INTEGER PRIMARY KEY AUTOINCREMENT,noktalar varchar(255) not null, x DOUBLE not null, sonuc DOUBLE, datetime DATETIME not null, username varchar(255) not null)";
