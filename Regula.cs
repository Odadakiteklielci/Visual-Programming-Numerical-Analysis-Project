    ...
    public partial class Regula : Form
    {
        ...
        public void createDatabase()
        {
            if (!File.Exists(dbName))
            {
                ...
                command.CommandText = "CREATE TABLE regulagecmis(id INTEGER PRIMARY KEY AUTOINCREMENT, fonksiyon varchar(255) not null, a INTEGER not null,b INTEGER not null, sonuc DOUBLE not null, datetime DATETIME not null, username varchar(255) not null)";
