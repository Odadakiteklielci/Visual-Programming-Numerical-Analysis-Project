...
{
    public partial class IleriYonTablo : Form
    {
        private SQLiteConnection connection;
        public IleriYonTablo()
        {
            InitializeComponent();
            connection = new SQLiteConnection("Data Source=ileriYonTablo.db;Version=3;");
        }

        private void IleriYonTablo_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                SQLiteDataAdapter adapter = new SQLiteDataAdapter("SELECT * FROM ileriyongecmis", connection);
