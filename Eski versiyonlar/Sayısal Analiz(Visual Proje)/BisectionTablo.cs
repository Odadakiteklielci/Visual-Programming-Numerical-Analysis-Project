...
{
    public partial class BisectionTablo : Form
    {
        private SQLiteConnection connection;
        public BisectionTablo()
        {
            InitializeComponent();
            connection = new SQLiteConnection("Data Source=bisectionTablo.db;Version=3;");
        }

        private void BisectionTablo_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                SQLiteDataAdapter adapter = new SQLiteDataAdapter("SELECT * FROM bisectiongecmis", connection);
