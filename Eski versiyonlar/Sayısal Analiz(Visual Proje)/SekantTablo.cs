...
{
    public partial class SekantTablo : Form
    {
        private SQLiteConnection connection;
        public SekantTablo()
        {
            InitializeComponent();
            connection = new SQLiteConnection("Data Source=sekantTablo.db;Version=3;");
        }
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                SQLiteDataAdapter adapter = new SQLiteDataAdapter("SELECT * FROM sekantgecmis", connection);
        ...
        private void SekantTablo_Load(object sender, EventArgs e)
        {
            LoadData();
