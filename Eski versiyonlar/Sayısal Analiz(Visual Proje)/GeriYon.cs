...
namespace Sayısal_Analiz_Visual_Proje_
{
    public partial class GeriYon : Form
    {
        ...
        public GeriYon(List<double> x, List<double> y)
        {
            InitializeComponent();
            this.x = x;
            this.y = y;
        ...
        public void createDatabase()
        {
            if (!File.Exists(dbName))
            {
                ...
                command.CommandText = "CREATE TABLE geriyongecmis(id INTEGER PRIMARY KEY AUTOINCREMENT,noktalar varchar(255) not null, x DOUBLE not null, sonuc DOUBLE, datetime DATETIME not null)";
